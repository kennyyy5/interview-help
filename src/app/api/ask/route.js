...
export async function POST(req) {
  try {
    ...
    const prompt = [
      ...
      `Q: "${question}"`,
      `If it's a behavioral, situational, or background question, give a brief story using the STAR format (Situation, Task, Action, Result). End with what was learned.`,
